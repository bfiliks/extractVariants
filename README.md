...
**Five things the 2022-23 team started but never finished are now built and published:**
...
- [`dictionary/index.html`](dictionary/index.html) — **"Eliminating the Other Meanings"**: the team's own 2022 method (look up a base word and its variant in Webster's 1844, keep only the sense they share) applied to the small set of entries they're known to have actually consulted — three recovered from screenshot images buried in their own conference slides, never captured by this project's earlier text-only extraction.
